...
const PostComment = ({ postId, user, detail }) => {
  const { comments, comment } = useSelector((state) => state.post);
    ...
    <section className="card bg-base-100 border border-base-200 rounded-2xl p-5 shadow-sm">
      <div className="flex items-start justify-between gap-4 mb-4">
        ...
        <div className="flex items-center gap-3 text-sm text-base-content/60">
          ...
          <span className="px-3 py-1 bg-base-200 rounded-full text-xs">
            Sorted: newest
          </span>
          <button
                ...
                {updatingCommentId ? (
                  <>
                    ...
                    >
                      ...
                      <span>
                        {comment.updateComment ? "Updating..." : "Update"}
                      </span>
                    </button>
                  </>
                ) : (
          ...
          {comments.loading || detail.loading ? (
            ...
            <button
              ...
              className={`link link-hover link-primary text-sm ${
                !comments.pagination?.nextPageURL
