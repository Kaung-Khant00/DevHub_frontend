...
function Stat({ value, label }) {
  return (
    <div className="stat">
      <div className="stat-value text-base md:text-2xl">{value ?? "—"}</div>
...
export default function DeveloperProfilePage({
  user = {
    ...
    bio: "Full‑stack engineer focused on React, Laravel, and delightful DX.",
    created_at: "2024-07-01T00:00:00Z",
  },
  profile = {
    skill: "React, Laravel, REST APIs, MySQL, Tailwind, Docker",
  ...
  const safeProfileUrl =
    user?.profile_url ||
    "https://api.dicebear.com/7.x/identicon/svg?seed=devhub";
          ...
          <div className="card-body p-4 md:p-6">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                ...
                <div className="mt-2 flex flex-wrap items-center gap-3 text-sm">
                  ...
                  <span className="opacity-70">Joined BLABALABLAB</span>
                </div>
              </div>
            ...
            <div className="mt-4">
              <div className="tabs tabs-boxed">
                <a className="tab" href="/profile/edit">
                  <FaEdit size={16} className="mr-2" /> Edit
                </a>
                <a className="tab" href="/groups/joined">
                  <FaFolder size={16} className="mr-2" /> Joined Groups
                </a>
                <a className="tab" href="/followers">
                  <FaUsers size={16} className="mr-2" /> Followers
                </a>
                <a className="tab" href="/notifications">
                  <FaBell size={16} className="mr-2" /> Notifications
                </a>
              </div>
            </div>
          </div>
      ...
      {isOwnProfile && (
        <div className="lg:hidden fixed bottom-4 left-0 right-0 flex justify-center">
          <div className="btn-group shadow-xl rounded-2xl">
            <a href="/profile/edit" className="btn btn-primary btn-sm gap-2">
              <FaEdit size={16} /> Edit
            </a>
